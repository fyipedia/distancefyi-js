/**
 * DistanceFYI API client — TypeScript wrapper for distancefyi.com REST API.
 *
 * Zero dependencies. Uses native `fetch`.
 *
 * @example
 * ```ts
 * import { DistanceFYI } from "distancefyi";
 * const api = new DistanceFYI();
...
export class DistanceFYI {
  private baseUrl: string;

  constructor(baseUrl = "https://distancefyi.com") {
